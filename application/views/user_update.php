...
<body>
    ...
    <div class="container">
        ...
        <?php endif; ?>
        <form action="<?= base_url('auth/updateDetails'); ?>" method="post">
            ...
            <div class="single-form">
                ...
                <input type="text" name="gName" id="gName" value="<?= $gName; ?>" required>
            </div>
            <div class="single-form">
                <label for="gCon">Guardian Contact</label>
                <input type="text" name="gCon" id="gCon" value="<?= $gCon; ?>" required>
            </div>
